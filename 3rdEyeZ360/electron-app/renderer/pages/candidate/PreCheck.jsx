...
export default function PreCheck({ onPass }) {
  ...
  const startChecks = async () => {
    ...
    try {
      ...
      // Face check — wait 2 seconds for face to appear
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <button onClick={onPass} disabled={!allPassed}
          className="btn btn-primary" style={{ width: '100%', padding: '12px 0', fontSize: 15,
